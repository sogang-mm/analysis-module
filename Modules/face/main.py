...
class Face():
    def __init__(self) :
        classifier_filename = os.path.join(os.path.dirname(os.path.realpath(__file__)),'210903.pkl')
        ...
        with tf.Graph().as_default():
            ...
            model =os.path.join(os.path.dirname(os.path.realpath(__file__)),'210903.pb')
